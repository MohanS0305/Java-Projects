package com.Gui.CyberBeatBox.Version2;
...
public class BeatBox {
		...
		String[] instrumentNames = {"Bass Drum", "Closed Hi-Hat", "Open Hi-Hat", "Acoustic snare",
												  "Crash Cymbal", "Hand Clay", "High Tom", "Hi Bonga", "Maracas", "Whistle",
		...
		public void buildGUI() {
			...
			start.addActionListener(e -> changeTempo(1.03f));
			buttonBox.add(upTempo);
			
			JButton downTempo = new JButton("Tempo Down");
			start.addActionListener(e -> changeTempo(0.97f));
		...
		private void readFile() {
			...
			try (ObjectInputStream os = new ObjectInputStream
					(new FileInputStream("checkbox.ser"))) {
		...
		private void writeFile() {
			...
			try (ObjectOutputStream os = new ObjectOutputStream
					(new FileOutputStream("checkbox.ser"))) {
